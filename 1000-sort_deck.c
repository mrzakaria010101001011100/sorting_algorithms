...
/**
 * get_value - return value of a card.
 * @card: A pointer to a deck_node_t
 *
...
/**
 * insertion_sort_deck_kind - sort deck head
 * @deck: sort the deck head
 */
void insertion_sort_deck_kind(deck_node_t **deck)
{
...
/**
 * sort_deck - Sort a deck of cards to ace to king and
